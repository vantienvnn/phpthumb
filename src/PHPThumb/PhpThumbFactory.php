 ...
 */
class PhpThumbFactory extends PHPThumb {
    ...
    public function autoResize($maxWidth, $maxHeight, $quadrant) {
        if ($this->currentDimensions['width'] > $maxWidth) {
            $ratio = $maxWidth / $this->currentDimensions['width'];
            $maxHeight = round($this->currentDimensions['height'] * $ratio);
        } elseif ($this->currentDimensions['height'] > $maxHeight) {
            $ratio = $maxHeight / $this->currentDimensions['height'];
            $maxWidth = round($this->currentDimensions['width'] * $ratio);
        }
        return $this->adaptiveResizeQuadrant($maxWidth, $maxHeight, $quadrant);
    }
     ...
     * @return \PHPThumb\PhpThumbFactory
     */
     ...
     *
     * @see \PHPThumb\PhpThumbFactory::$currentDimensions
     */
     ...
     *
     * @see \PHPThumb\PhpThumbFactory::$newDimensions
     */
     ...
     * Returns $options.
     *
     * @see \PHPThumb\PhpThumbFactory::$options
     */
     ...
     * Returns $percent.
     *
     * @see \PHPThumb\PhpThumbFactory::$percent
     */
     ...
     * Returns $oldImage.
     *
     * @see \PHPThumb\PhpThumbFactory::$oldImage
     */
     ...
     *
     * @see \PHPThumb\PhpThumbFactory::$workingImage
     */
